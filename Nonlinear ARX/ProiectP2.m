...
for na = 1:3
    for m = 1:4
        ...
        row2 = zeros(1, 2*na); 
        powMat2 = [];
        powMat2 = createPow(row2, 0, 2*na, m, powMat2);  % creare matrice puter
...
hold on
plot(yval,"b")
title(["simulation na = " num2str(naSym), " m = " num2str(mSym)])
% Simulare Identificare
figure
plot(YhatSymID,"r", 'LineWidth', 2);
hold on
plot(yid,"b")
title(["simulation na = " num2str(naSymID), " m = " num2str(mSymID)])
% Predictie validare
figure
plot(YhatPredict,"r", 'LineWidth', 2);
hold on
plot(yval,"b")
title(["prediction na = " num2str(naPredict), " m = " num2str(mPredict)])
% Predictie identificare
figure
plot(YhatPredictID,"r", 'LineWidth', 2);
hold on
plot(yid,"b")
title(["prediction na = " num2str(naPredictID), " m = " num2str(mPredictID)])
